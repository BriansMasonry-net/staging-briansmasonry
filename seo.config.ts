...
/* Image host. Today the images are still served by the old WordPress box.
   AD-9 says they belong in Backblaze behind img.briansmasonry.net — when
   gate 7 (wp-11-turn-on-image-address) lands, this one constant changes and
   every OG image and every schema image URL follows it. */
export const IMAGE_HOST = 'https://briansmasonry.net/wp-content/uploads';
